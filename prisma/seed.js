...
async function main() {
  ...
  // Clear existing data (ALWAYS delete children first)
// Delete all tables that reference Patient first
await prisma.vitals.deleteMany();          // 🔥 new
await prisma.invoice.deleteMany();         // 🔥 if exists
await prisma.patientUpdate.deleteMany();
...
await prisma.user.deleteMany();
  ...
  await prisma.review.create({
    data: {
      ...
      rating: 5,
      comment:
        "Dr. Priya Sharma is excellent! Very thorough and caring. Highly recommend for heart issues.",
    },
  });
  ...
  await prisma.review.create({
    data: {
      ...
      rating: 5,
      comment:
        "Dr. Arjun Patel explained everything clearly. Great neurologist!",
    },
  });
  ...
  await prisma.review.create({
    data: {
      ...
      rating: 4,
      comment:
        "Great hospital with modern facilities and friendly staff. Clean environment.",
    },
  });
  ...
  await prisma.review.create({
    data: {
      ...
      rating: 5,
      comment:
        "The cardiology department is top-notch! Best treatment I have received.",
    },
  });
  ...
  await prisma.review.create({
    data: {
      ...
      rating: 5,
      comment:
        "Kavita Singh was very kind and professional during my emergency visit.",
    },
  });
  ...
  await prisma.notification.create({
    data: {
      ...
      type: "INFO",
      message:
        "Your appointment with Dr. Priya Sharma is confirmed for January 15, 2025",
  ...
  await prisma.notification.create({
    data: {
      ...
      type: "SUCCESS",
      message:
        "Your test results are ready. Please check your medical records.",
