...
export default function NurseDashboardSidebar({ userName = "Nurse", profilePic }) {
  return (
    <div className="w-full md:w-64 lg:w-72 bg-slate-50 border-r border-gray-200 p-6 flex flex-col">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-gray-500 text-sm">Nurse</p>
      </div>

      <nav className="flex flex-col gap-2">
        <IconLink href="/dashboard/nurse" icon={<IconDashboard />} label="Dashboard" active />
        <IconLink href="/dashboard/nurse/triage" icon={<IconClipboard />} label="Patient Triage" />
        <IconLink href="/dashboard/nurse/patients" icon={<IconUsers />} label="Assigned Patients" />
        <IconLink href="/dashboard/nurse/profile" icon={<IconSettings />} label="Profile Settings" />
      </nav>
