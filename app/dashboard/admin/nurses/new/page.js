    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                const errorMessage = errorData.error || "Failed to create nurse";
                alert(errorMessage);
            ...
            window.showToast?.({ type: "success", message: "Nurse registered successfully!" });
                ...
                <main className="flex-1 p-6 md:p-10 max-w-4xl mx-auto overflow-y-auto">
                    ...
                    <header className="mb-8">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            Enter the details to register a new nurse
                        </p>
                    </header>
