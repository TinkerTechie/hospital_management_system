...
export default function DoctorAppointmentsPage() {
    ...
    // Mock Data
    const appointments = [
        { id: 1, patient: "Sarah Johnson", time: "09:00 AM", type: "General Checkup", status: "Completed", date: "Today" },
        { id: 2, patient: "Michael Chen", time: "10:30 AM", type: "Follow-up", status: "Upcoming", date: "Today" },
        { id: 3, patient: "Emma Wilson", time: "02:00 PM", type: "Consultation", status: "Upcoming", date: "Today" },
        { id: 4, patient: "James Brown", time: "04:15 PM", type: "Emergency", status: "Cancelled", date: "Today" },
        { id: 5, patient: "Linda Davis", time: "09:00 AM", type: "General Checkup", status: "Completed", date: "Yesterday" },
        { id: 6, patient: "Robert Miller", time: "11:00 AM", type: "Lab Review", status: "Completed", date: "Yesterday" },
    ];
                                        ...
                                        <tr key={appt.id} className="group hover: dark:hover:bg-gray-700 transition-colors">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="font-medium text-gray-900 dark:text-white">{appt.patient}</p>
                                                        <p className="text-xs text-gray-500 dark:text-gray-400">ID: #{1000 + appt.id}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="px-6 py-4">
                                                <div className="flex flex-col">
                                                    <span className="text-sm text-gray-900 dark:text-white font-medium">{appt.time}</span>
                                                    <span className="text-xs text-gray-500 dark:text-gray-400">{appt.date}</span>
                                                </div>
                                            </td>
                                            <td className="px-6 py-4">
                                                <span className="text-sm text-gray-600 dark:text-gray-300">{appt.type}</span>
                                            </td>
                                            <td className="px-6 py-4">
